...
{
    public class Lejemaal : BaseEntity
    {
        ...
        public Lejemaal(string vejNavn, int bygningsNummer, string andenAdresse, string postNummer, string city, string region, string landKode, bool isBookable, int ejendomId)
        {
            VejNavn = vejNavn;
